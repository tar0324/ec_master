...
function chk(){
	if(!($('#req').is(':checked'))){
		...
		location.href="${contextPath}/seller/member/memberForm_sdetail.do";
		}
	}

function nochk(){
 alert("동의하지 않으면 가입하실 수 없습니다");
location.href="${contextPath}/seller/member/s_regadmin.do";}
</script>
<meta charset="UTF-8">
<title>약관동의</title>
</head>
...
<table width="100%" height="650">
  <tr>
   ...
   <span><a href="${contextPath }/seller/member/loginForm.do"><img src="${contextPath }/image/logo_7f78.png" width="200" height="150" alt="로고사진"></a>
   </span>
   </p>
   <br>
   <textarea
